...
export default function WhatsAppCheckout() {
  ...
  return (
    <button
      ...
      className="w-full py-4 bg-whatsapp text-white rounded-xl font-semibold text-base hover:bg-whatsapp-dark active:scale-[0.98] transition-all flex items-center justify-center gap-2.5"
    >
